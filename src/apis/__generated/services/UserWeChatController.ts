...
export class UserWeChatController {
  ...
  async delete(options: UserWeChatControllerOptions['delete']): Promise<boolean | undefined> {
  ...
  async register(options: UserWeChatControllerOptions['register']): Promise<SaTokenInfo> {
