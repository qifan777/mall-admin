  ...
  <div class="create-form">
    <el-form labelWidth="120" class="form" ref="createFormRef" :model="createForm" :rules="rules">
      ...
      <el-form-item label="标签" prop="tags">
        <values-input v-model="createForm.tags"></values-input>
      </el-form-item>
      <el-form-item label="规格" prop="specifications">
        <key-values-input v-model="createForm.specifications"></key-values-input>
      </el-form-item>
      <el-form-item label="属性" prop="attributes">
        <key-values-input v-model="createForm.attributes"></key-values-input>
      </el-form-item>
    </el-form>
