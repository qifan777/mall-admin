...
import type { CouponUseRecordInput, CouponUseRecordSpec, Page, QueryRequest } from '../model/static'

export class CouponUseRecordController {
  constructor(private executor: Executor) {}

  async delete(options: CouponUseRecordControllerOptions['delete']): Promise<boolean> {
  ...
  ): Promise<Page<CouponUseRecordDto['CouponUseRecordRepository/COMPLEX_FETCHER']>> {
  ...
  async save(options: CouponUseRecordControllerOptions['save']): Promise<string> {
