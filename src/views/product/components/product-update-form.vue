...
import KeyValuesInput from '@/views/product/components/key-values-input.vue'
  ...
  <div class="update-form">
    <el-form labelWidth="120" class="form" ref="updateFormRef" :model="updateForm" :rules="rules">
      ...
      <el-form-item label="标签" prop="tags">
        <values-input v-model="updateForm.tags"></values-input>
      </el-form-item>
      <el-form-item label="规格" prop="specifications">
        <key-values-input v-model="updateForm.specifications"></key-values-input>
      </el-form-item>
      <el-form-item label="属性" prop="attributes">
        <key-values-input v-model="updateForm.attributes"></key-values-input>
      </el-form-item>
    </el-form>
