...
import type { AgentLevelDto } from '@/apis/__generated/model/dto'
import { Delete, Edit, Plus } from '@element-plus/icons-vue'
import DictColumn from '@/components/dict/dict-column.vue'
import { DictConstants } from '@/apis/__generated/model/enums/DictConstants'

type AgentLevelScope = Scope<AgentLevelDto['AgentLevelRepository/COMPLEX_FETCHER']>
...
const handleCreate = () => {
  openDialog('CREATE')
  createForm.value = { ...agentLevelStore.initForm }
}
...
const handleDelete = (ids: string[]) => {
  ElMessageBox.confirm('此操作将删除数据且无法恢复, 是否继续?', '警告', {
    ...
    api.agentLevelController.delete({ body: ids }).then((res) => {
...
<template>
  <div>
    ...
    >
      ...
      <el-table-column label="佣金比例" prop="rate" sortable="custom">
