...
export class ProductAttributeController {
  ...
  async delete(options: ProductAttributeControllerOptions['delete']): Promise<boolean> {
  ...
  ): Promise<ProductAttributeDto['ProductAttributeRepository/COMPLEX_FETCHER']> {
  ...
  ): Promise<Page<ProductAttributeDto['ProductAttributeRepository/COMPLEX_FETCHER']>> {
  ...
  async save(options: ProductAttributeControllerOptions['save']): Promise<string> {
