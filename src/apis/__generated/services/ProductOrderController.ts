...
export class ProductOrderController {
  ...
  async create(options: ProductOrderControllerOptions['create']): Promise<string> {
  ...
  async delete(options: ProductOrderControllerOptions['delete']): Promise<boolean | undefined> {
