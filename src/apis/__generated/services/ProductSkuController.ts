...
export class ProductSkuController {
  ...
  async delete(options: ProductSkuControllerOptions['delete']): Promise<boolean | undefined> {
  ...
  async saveBatch(options: ProductSkuControllerOptions['saveBatch']): Promise<boolean | undefined> {
