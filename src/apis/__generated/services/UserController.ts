...
export class UserController {
  ...
  async getUserMenus(): Promise<Array<MenuDto['MenuRepository/COMPLEX_FETCHER']>> {
  ...
  async getUserMenusTree(): Promise<Array<MenuDto['MenuRepository/MENU_TREE_FETCHER']>> {
  ...
  async register(options: UserControllerOptions['register']): Promise<SaTokenInfo> {
    ...
    return (await this.executor({ uri: _uri, method: 'POST', body: options.body })) as SaTokenInfo
  }
