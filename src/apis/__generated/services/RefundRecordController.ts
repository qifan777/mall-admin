...
import type { Page, QueryRequest, RefundRecordInput, RefundRecordSpec } from '../model/static/'

export class RefundRecordController {
  constructor(private executor: Executor) {}

  async delete(options: RefundRecordControllerOptions['delete']): Promise<boolean | undefined> {
