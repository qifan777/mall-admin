...
import type { AddressInput, AddressSpec, Page, QueryRequest } from '../model/static/'

export class AddressController {
  constructor(private executor: Executor) {}

  async delete(options: AddressControllerOptions['delete']): Promise<boolean | undefined> {
  ...
  async getUserAddress(): Promise<Array<AddressDto['AddressRepository/SIMPLE_FETCHER']>> {
  ...
  async top(options: AddressControllerOptions['top']): Promise<boolean | undefined> {
